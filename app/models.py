...
class Booking(Base):
    ...
    # reference_code = Column(String, nullable=False, index=True) (previous bug)
    reference_code = Column(String, nullable=False, unique=True, index=True)  # bug fixed: enforce unique refs
...
class RefundLog(Base):
    ...
    id = Column(Integer, primary_key=True)
    # booking_id = Column(Integer, ForeignKey("bookings.id"), nullable=False, index=True) (previous bug)
    booking_id = Column(Integer, ForeignKey("bookings.id"), nullable=False, unique=True, index=True)  # bug fixed
